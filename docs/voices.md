...
- `professor-frink`: Professor Frink (The Simpsons) (Hank Azaria)
...
- `rey-mysterio`: Rey Mysterio (trained by justinjohn-03)
...
- `millibot-281-486-itterations`: MilliBot-281 486 itterations
...
- `lindsey-thorndyke`: Lindsey Thorndyke - Karen Neill; Veronica Taylor - 'Sonic's Scream Test' (Sonic X)
...
- `ryuji-sakamoto`: Ryuji Sakamoto (Max Mittleman)
- `sammy-lawrence-talking-in-audio-logs`: Sammy Lawrence talking in audio logs (bendy and the ink machine)
...
- `tails2`: Tails (Amy Palant)
- `taizo-hori`: Taizo Hori
- `tat`: tat
- `teenager`: Teenager - Deep Voice
- `ten`: Ten
- `tennis-ball`: Tennis Ball
- `terrance`: Terrance
- `terrible-zooger-voice`: Terrible Zooger voice
- `test`: Test
- `test-model`: Test model (Mike)
- `test000`: test000
- `tetsuko`: Tetsuko (Marcy Bannor, The Super Milk-Chan Show)
- `the-king-of-all-cosmos`: The King of All Cosmos (Katamari Damacy)
- `the-unlucky-tug`: The Unlucky Tug (Nic Goodrich)
- `thomas-the-tank-engine`: Thomas the Tank Engine (Eddie Glen)
- `tttt`: Tttt
...
- `willyrex`: willyrex
- `wood-man`: Wood Man (SSHHS Part III, by Just_aPerson)
- `woody-woodpecker`: Woody Woodpecker (Grace Stafford) by finger-player
- `xan`: Xan - Baldur's Gate (Jeff Bennet)
- `xxx`: xxx
- `yellow-face`: Yellow Face
- `yuri`: Yuri
- `zuzu-linda-from-zuzubalandia`: Zuzu Linda From Zuzubalandia